...
// This function is required for static exports, but since we are handling this page
// on the client, we return an empty array. This tells Next.js not to pre-render
// any specific case pages at build time.
